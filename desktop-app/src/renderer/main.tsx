...
function App() {
  const [state, setState] = useState<AppState>({ posts: [], settings: defaultSettings, collectionState: "stopped", appVersion: "0.1.6", operationLog: [], stats: emptyStats, clients: [] });
  ...
  return (
    <main className={flashUi ? "flash-ui" : ""}>
      ...
      <header className="topbar">
        <div>
          <h1>Facebook Opportunity Radar <span className="version-badge">v{state.appVersion || "0.1.6"}</span></h1>
